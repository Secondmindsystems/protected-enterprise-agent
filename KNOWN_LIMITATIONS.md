...
- Semantic Guardrails thresholds must be calibrated from observed responses of the pinned runtime. The default `0.70` policy is provisional until that calibration is recorded.
